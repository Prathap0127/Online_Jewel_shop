...
let dashBoard = async()=>{
    try{
        ...
        let resProduct = await fetch(url+"products")
        ...
        <div class="card-body">
          ...
          <a href="admin-dashboard-customer.html" class="btn btn-primary">View</a>
        </div>
      </div>
      </div>
      <div class="col-sm-4">
      ...
      <div class="card-body">
        ...
        <h3 class="card-text">${productData.length}</h3>
        <a href="b-dashboard-product-add-product.html" class="btn btn-primary">View</a>
      </div>
    </div>
    </div>
    <div class="col-sm-4">
      ...
      <div class="card-body">
        ...
        <a href="b-dashboard-orders.html" class="btn btn-primary">View</a>
      </div>
    </div>
    </div>
        `
